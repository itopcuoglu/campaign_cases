...
export KYNEMA_DIR=/glade/campaign/uwyo/wyom0218/topcuoglu/kynema_current/kynema-manager
cd ${KYNEMA_DIR}
source shortcut.sh
...
#mpiexec --cpu-bind depth -n 1536 -ppn 128 -d 1 kynema_sgf ./nrel5mw_amr.inp &> nrel5mw_amr.log
